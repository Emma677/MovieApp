...
const Home = () => {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      ...
      headerRight: () => (
        <Pressable
          style={{ flexDirection: "row", marginRight: 3, alignItems: "center" }}
        >
  ...
  return (
    <View>
      <FlatList
      // the sorted data was created later on to aid in the function called applyfilter 
      // initially data was used but when a state was created called [sortedData,setSortedData] we used thatb instead
        data={sortedData}
      ...
      >
        <ModalContent style={{ height: 200, width: "100%" }}>
          ...
          >
            {languages.map((item, index) => (
              ...
              >
                ...
                <Pressable onPress={()=> setSelectedFilter(item.language)}
                style={{
                  margin: 5,
                  borderColor: "gray",
                  borderWidth: 1,
